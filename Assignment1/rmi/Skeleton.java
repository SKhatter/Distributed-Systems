...
public class Skeleton<T>
{
	   ...
	   private final Set<RMIClientThread> set = new LinkedHashSet<RMIClientThread>();
    ...
    public synchronized void start() throws RMIException
    {
    	...
    	try{
    		if(address == null){
    			...
    			address = new InetSocketAddress(hostAddress, serverSocket.getLocalPort());
    		...
    		activeThread = new ActiveThread(serverSocket, server, c, set, this);
    ...
    private void checkParameters(Class<T> interfaceClass, T server) {
